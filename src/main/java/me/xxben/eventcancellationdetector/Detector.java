...
public class Detector<TEvent extends Event> {

    /*
        CODE USED FROM: https://gist.github.com/aadnk/5563794#file-cancellationdetector-java
        Put and formed into my own private plugin for use
     */
    ...
    public Detector(Class<TEvent> eventClazz) {
